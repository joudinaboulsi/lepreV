        ...
        <div class="container">
            <div class="row">
                                ...
                                <div class="box" id="A" onclick="fnChangeBorder('A')">
                                    ...
                                    <label for="match_1">
                                        <svg class="highlight-cat1" xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="313" height="312"
                                            viewBox="0 0 313 312">
                                            {{-- border --}}
                                            <defs>
                                            ...
                                            <g id="Group_12386" data-name="Group 12386"
                                                ...
                                                <g id="Group_12382" data-name="Group 12382" transform="translate(0 0)">
                                                    ...
                                                    <path id="Path_336" data-name="Path 336"
                                                        d="M24.388,0V27.411H16.56V0" transform="translate(-2.547 -0.001)"
                                            ...
                                            <text id="_250_ml" data-name="250 ml" transform="translate(150.5 231.5)"
                                            ...
                                            <g id="Group_12384" data-name="Group 12384"
                                                ...
                                                <g id="Group_12380" data-name="Group 12380" transform="translate(0)">
                                                    ...
                                                    <path id="Path_365" data-name="Path 365"
                                                        ...
                                                        stroke="#2e613a" stroke-miterlimit="10" stroke-width="1" />
                                                    ...
                                                    <path id="Path_369" data-name="Path 369"
                                                        d="M31.518,0V36.876H24.964V0" transform="translate(-7.093)"
                                                        fill="none" />
                                                    <path id="Path_368" data-name="Path 368"
                                                        d="M31.518,0V35.992H24.964V0" transform="translate(-7.093 -0.256)"
                                                        fill="#fff" />
                                                </g>
                                            </g>
                                            <text id="_750_ml" data-name="750 ml" transform="translate(150.5 231.5)"
                                                fill="#b8ba43" font-size="30" font-family="Helvetica-Bold, Helvetica"
                                                font-weight="700" letter-spacing="-0.07em">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div id="C" onclick="fnChangeBorder3('C')" class="cat3">
                                    ...
                                    <label for="match_3">
                                        <svg class="highlight-cat3" xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <g id="Group_12383" data-name="Group 12383"
                                                ...
                                                <g id="Group_12381" data-name="Group 12381" transform="translate(0 0)">
                                                    ...
                                                    <path id="Path_371" data-name="Path 371"
                                                        ...
                                                        stroke="#708c9b" stroke-miterlimit="10" stroke-width="1" />
                                                    ...
                                                    <rect id="Rectangle_1406" data-name="Rectangle 1406" width="0.199"
                                                        height="1.02" transform="translate(18.944 84.491)"
                                                        fill="#708c9b" />
                                            ...
                                            <text id="_500_ml" data-name="500 ml" transform="translate(150.5 231.5)"
                                                fill="#b8ba43" font-size="30" font-family="Helvetica-Bold, Helvetica"
                                                font-weight="700" letter-spacing="-0.07em">
                ...
                <div class="btns">
                    ...
                    <button onclick="location.href='{{ route('customize.step-two') }}'"
